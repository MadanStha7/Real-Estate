...
from api.urls.serviceprovider import urlpatterns as serviceprovider_routes
from api.urls.property_service import urlpatterns as property_service_routes
urlpatterns = [
