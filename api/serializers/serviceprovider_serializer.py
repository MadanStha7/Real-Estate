...
class ServiceProviderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "user", "username", "service_name", "company_name",
                  "address", "price", "contact_number",
                  "description", "photos_or_videos",
                  "added_at", "location", "latitude", "longitude",
                  "business_hours", "custom_field")
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Review
        fields = ('id', 'user', 'username', 'service_provider', 'date',
                  'rating', 'description', 'recommend')
